...
function initEcharts(){
    ...
    pvChart = echarts.init(document.getElementById('articlepvEcharts'));
    ...
    initChart(pvChart, pvText.title, pvDesc.description);
}
...
function queryChartButtonClick(){
	$("#queryChartButton").click(
        function() {
            ...
            loadChartByType(statementRequest);
        }
    );
}
...
function loadChartByType(statementRequest){
	var chartObj=pvChart;
	var chartText=pvDesc;
